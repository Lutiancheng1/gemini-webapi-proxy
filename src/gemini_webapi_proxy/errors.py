...
class ImageExportError(RuntimeError):
    ...
    Mapped to HTTP 502 by :func:`gemini_webapi_proxy.routes._errors.map_api_error`.
    """
...
class CookieExpiredError(ImageExportError):
    ...
    Mapped to HTTP 401.  Triggers :func:`gemini_webapi_proxy.client.pool.invalidate_client`
