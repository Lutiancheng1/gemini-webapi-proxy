...
between the pluggable :mod:`gemini_openai_proxy.cookies` sources and the
HTTP layer.
"""
...
from gemini_openai_proxy.client.registry import ModelRegistry
from gemini_openai_proxy.config import Settings, get_settings
from gemini_openai_proxy.cookies import build_source
from gemini_openai_proxy.cookies.session_bootstrap import bootstrap_browser_cookie_session
...
async def close_client() -> None:
    ...
    if _client is not None:
        await _client.close()
        _client = None
    from gemini_openai_proxy.downloaders.playwright_downloader import close_browser_fetch
